...
export function SegmentsView() {
  ...
  const filtered = (leads ?? []).filter((lead) => (lead.score?.total ?? 0) >= minimum && (!country || lead.country === country));
  return (
    <div>
